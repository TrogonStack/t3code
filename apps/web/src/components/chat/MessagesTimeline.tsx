...
const PlainWorkEntryRow = memo(function PlainWorkEntryRow(props: {
  ...
  const displayText =
    subagent !== null
      ? subagent.heading
      : !toolPresentation && expanded && workEntry.command?.trim()
        ? "Command"
        : previewText;
  ...
  const headingClass = showWarningIndicator
    ...
    : showDestructiveRowStyle
      ...
      : workLogEntryIsToolLike(workEntry)
        ...
        : "text-foreground/80";
  // De-clutter the icon column inside an expanded tool group, where every row
  // otherwise repeats the same glyph; failures and warnings still need it.
