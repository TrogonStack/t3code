    ...
    execute: () =>
      sql`
        SELECT
          ...
          forked_up_to_message_id AS "forkedUpToMessageId",
          fork_mode AS "forkMode",
          pending_fork_context AS "pendingForkContext",
          ...
          ([
            ...
            Effect.gen(function* () {
              ...
              const threads: ReadonlyArray<OrchestrationThread> = threadRows.map((row) => ({
                ...
                forkedUpToMessageId: row.forkedUpToMessageId,
                forkMode: row.forkMode,
                pendingForkContextText: row.pendingForkContext,
  ...
  const getThreadShellById: ProjectionSnapshotQueryShape["getThreadShellById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      return Option.some({
        ...
        forkedUpToMessageId: threadRow.value.forkedUpToMessageId,
        forkMode: threadRow.value.forkMode,
  ...
  const getThreadDetailById: ProjectionSnapshotQueryShape["getThreadDetailById"] = (threadId) =>
    Effect.gen(function* () {
      ...
      const thread = {
        ...
        forkedUpToMessageId: threadRow.value.forkedUpToMessageId,
        forkMode: threadRow.value.forkMode,
        pendingForkContextText: threadRow.value.pendingForkContext,
        latestTurn: Option.isSome(latestTurnRow) ? mapLatestTurn(latestTurnRow.value) : null,
        createdAt: threadRow.value.createdAt,
        updatedAt: threadRow.value.updatedAt,
        archivedAt: threadRow.value.archivedAt,
