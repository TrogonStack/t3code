...
| Secret reference    | A provider environment value naming a credential instead of carrying it, such as a 1Password `op://` reference. See [provider secrets](../user/provider-secrets.md). |
