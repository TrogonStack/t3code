...
Tick a file off in the **Code** tab once you have read it; it collapses, and the toolbar tracks how
many files you have cleared. Untick it to reopen the file. Ticks are stored on the pull request
itself, so a review picks up where you left it on another machine or in a browser, and a file
pushed to after you cleared it comes back marked **Changed**. GitHub only; scoping the **Code** tab
to a single commit keeps the checkboxes, since a tick belongs to the pull request, not the commit.
